        ...
        <div className="bg-white/5 rounded-lg border border-white/10 p-4 overflow-hidden mt-16">
            <div className="flex items-center justify-between px-2 mb-2">
                <div className="flex items-center gap-2">
                    <span className="text-blue-200 font-semibold text-sm w-5 text-right shrink-0">#</span>
                    <span className="text-blue-200 font-semibold text-sm">Mappers</span>
                </div>
                <span className="text-blue-200 font-semibold text-sm">Created</span>
            </div>
