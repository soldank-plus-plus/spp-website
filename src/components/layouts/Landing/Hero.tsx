        ...
        >
            <motion.div
                ...
                <h1 className="mt-60 mb-6">
                    Unique 2D (side-view) arcade game<br/>
                    Soldank++
                </h1>

                <p className="mb-10 max-w-3xl mx-auto">
                    The main part of the game is based on passing various maps of difficulty with the possibility of achieving faster time than other players.
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-xs mx-auto">
                    <Button size="lg" className="bg-accent hover:bg-accenthover w-full sm:w-auto">
                        Early Access
