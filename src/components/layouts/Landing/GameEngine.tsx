                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 w-full max-w-[1000px]">
                    <div className="flex flex-col justify-center items-start gap-y-4 text-left max-w-sm">
                        ...
                        <p className="text-sm text-white/70">
                            ...
                            objective is to replicate all existing core
                            mechanics precisely while expanding upon them.
                            Furthermore, the project is committed to fully
                            replacing certain legacy features, such as netcode,
                            with a server-authoritative system, preventing some
