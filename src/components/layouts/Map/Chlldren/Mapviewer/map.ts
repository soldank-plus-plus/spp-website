...
class Reader {
    ...
    i8(): number { return this.view.getInt8(this.offset++); }
...
function bgra(b: number, g: number, r: number, a: number): RGBA { return [r, g, b, a]; }
function vec3(x: number, y: number, z: number): Vec3 { return { x, y, z }; }

function readVertex(r: Reader): Vertex {
    return {
        x: r.f32(), y: r.f32(), z: r.f32(), rhw: r.f32(),
...
function readObject(r: Reader, data: PmsMap): MapObject {
    const obj: MapObject = {
        active: r.u8() !== 0,
        style: 0, width: 0, height: 0, x: 0, y: 0,
        rotation: 0, scalex: 0, scaley: 0,
        color: [0, 0, 0, 0], level: 0,
    };
    r.skip(1);
    obj.style = r.u16();
    obj.width = r.i32();
    ...
    obj.scalex = r.f32();
    obj.scaley = r.f32();
    data.scenery_counts[obj.style - 1] = (data.scenery_counts[obj.style - 1] ?? 0) + 1;
    const alpha = r.u8();
    r.skip(3);
...
function readImages(r: Reader, data: PmsMap): void {
    ...
    data.scenery_counts = Array.from(data.scenery_counts, (v) => (v === undefined ? 0 : v));
}
...
function readWaypoint(r: Reader): WayPoint {
    const w: WayPoint = {
        active: r.u8() !== 0, id: 0, x: 0, y: 0,
        left: false, right: false, up: false, down: false,
        jet: false, path: 0, action: 0, c2: 0, c3: 0, cconnections: [],
    };
    r.skip(3);
    w.id = r.i32();
    w.x = r.i32();
...
export function parseMap(buffer: ArrayBuffer): PmsMap {
    ...
    const data: PmsMap = {
        id: "",
        version: 0, name: "", texture: "",
        bg_color_top: [0, 0, 0, 0], bg_color_bottom: [0, 0, 0, 0],
        jet_amount: 0, grenades: 0, medikits: 0, weather: 0, steps: 0, rand_id: 0,
        polygons: [], bgpolygons: [],
        sector_division: 0, num_sectors: 0, sectors: [],
        objects: [], images: [], scenery_counts: [],
        colliders: [], spawnpoints: [], waypoints: [],
    };
    readHeader(r, data);
    readPolygons(r, data);
    readSectors(r, data);
