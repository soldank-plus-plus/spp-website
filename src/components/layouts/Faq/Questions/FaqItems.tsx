...
export const faqItems = [
    {
        ...
        answer: (
            <>
                Soldank++ is a unique 2D (side-view) arcade game based on the
                legendary 2D Soldat engine made by Nedi. The main part of the
                game is based on passing various maps of difficulty with the
                possibility of achieving faster time than other players. Side
                modes offer a variety of multiplayer options including shooting
                competition, hide and seek, dodgeball, zombies and much more.
                List of full gameplay features can be found{" "}
    ...
    },
    {
        ...
        answer: (
            <>
                Yes! That’s the main goal of the project — The primary objective
                is to replicate all existing core mechanics precisely while
                expanding upon them. Furthermore, the project is committed to
                fully replacing certain legacy features, such as netcode, with a
                server-authoritative system, preventing some existing
                vulnerabilities.
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                As of now, several new features and improvements have been
    ...
    },
    {
        ...
        answer: (
            <>
                ...
                are cross-platform. The latest binaries are available for
                download (macOS should work too but it was not tested).
            </>
        ),
    },
    {
