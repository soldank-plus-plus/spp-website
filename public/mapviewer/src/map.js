...
function read_objects(r, data)
{
	...
	for (var i = 0; i < count; i++)
		data.objects.push(read_object(r, data));
}

function read_object(r, data)
{
	...
	object.scalex = r.f32();
	object.scaley = r.f32();
	data.scenery_counts[object.style-1] = (data.scenery_counts[object.style-1] + 1) || 1;
...
function read_images(r, data)
{
	...
	if (data.images.length>data.scenery_counts.length) data.scenery_counts.length=data.images.length;
